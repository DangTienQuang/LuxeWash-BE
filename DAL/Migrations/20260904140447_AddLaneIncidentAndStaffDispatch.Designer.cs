...
namespace AutoWashPro.DAL.Migrations
{
    ...
    [Migration("20260904140447_AddLaneIncidentAndStaffDispatch")]
    partial class AddLaneIncidentAndStaffDispatch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoWashPro.DAL.Entities.LaneIncident", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("LaneReactivated")
                        .HasColumnType("tinyint(1)");

                    b.Property<DateTime>("ReportedAt")
                        .HasColumnType("datetime(6)");

                    b.Property<string>("ReportedByFullName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
                    ...
                    b.HasIndex("BranchId", "Status", "ReportedAt");

                    b.ToTable("LaneIncidents");
                });
            ...
            modelBuilder.Entity("AutoWashPro.DAL.Entities.StaffLaneDispatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DispatchedByFullName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
                    ...
                    b.Property<string>("IncidentResolution")
                        .HasMaxLength(30)
                        .HasColumnType("varchar(30)");
                    ...
                    b.Property<string>("NoteFromStaff")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)");
                    ...
                    b.HasIndex("BranchId", "Status", "DispatchedAt");

                    b.HasIndex("StaffUserId", "Status", "DispatchedAt");

                    b.ToTable("StaffLaneDispatches");
                });
            ...
            modelBuilder.Entity("AutoWashPro.DAL.Entities.StaffLaneDispatch", b =>
                {
                    b.HasOne("AutoWashPro.DAL.Entities.Lane", "Lane")
                        .WithMany("StaffLaneDispatches")
                        .HasForeignKey("LaneId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AutoWashPro.DAL.Entities.LaneIncident", "RelatedIncident")
                        .WithMany("Dispatches")
            ...
            modelBuilder.Entity("AutoWashPro.DAL.Entities.Lane", b =>
                {
                    b.Navigation("LaneIncidents");

                    b.Navigation("ProcessingBookings");

                    b.Navigation("StaffLaneDispatches");
                });
